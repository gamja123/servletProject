...
<c:choose>
	...
	<tr>
		<td align="center" colspan="3"><c:out value="${loginID }" /> 님 환영합니다.</td>
	</tr>
	
	<tr>
		<td width="100" align="center">
			<a href="member.mdo?cmd=modifyForm">정보 수정</a>
		</td>
	...
	<c:otherwise>
		...
		<tr>
			<td colspan="2" align="center">
				...
				<input type="button" value="회원가입" onclick="javascript:window.location='member.mdo?cmd=regForm' ">
			</td>
		</tr>
