...
<b>글 삭제</b>
<br><br>
<form action="/board/deletePro.bdo?pageNum=${pageNum }" method="post" name="delForm" onsubmit="return deleteSave()">
...
<table border="1" align="center" cellpadding="0" cellspacing="0" width="360">
	...
	<tr height="30">
		<td align="center">
			비밀번호 : <input type="password" name="pass" size="10" maxlength="12">
